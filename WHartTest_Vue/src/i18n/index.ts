...
const LEGACY_EXACT_EN_MAP: Record<string, string> = {
  ...
  // ── AI 源码分析 (Code Analysis) ──
  'AI 源码分析': 'AI Code Analysis',
  'AI源码分析': 'AI Code Analysis',
  '代码项目': 'Code Projects',
  'OpenAPI 分析': 'OpenAPI Analysis',
  '组件分析': 'Component Analysis',
  '新建项目': 'New Project',
  '新建代码项目': 'New Code Project',
  '项目名称': 'Project Name',
  '请输入项目名称': 'Enter project name',
  '暂无代码项目，请新建一个': 'No code projects yet. Create one to get started.',
  '文件': 'Files',
  '拖拽或点击上传 zip 源码包': 'Drag or click to upload a zip source archive',
  '上传中...': 'Uploading...',
  '上传成功': 'Upload successful',
  '上传失败': 'Upload failed',
  '请上传 .zip 格式的源码包': 'Please upload a .zip source archive',
  '上传规范文件': 'Upload Spec File',
  '或': 'or',
  '输入 OpenAPI URL': 'Enter OpenAPI URL',
  '分析': 'Analyze',
  '分析任务': 'Analysis Tasks',
  '暂无分析任务': 'No analysis tasks yet',
  '暂无分析任务，点击上方按钮开始': 'No analysis tasks yet. Click the button above to start.',
  '条建议': 'suggestions',
  '接口建议列表': 'Interface Suggestions',
  '方法 + 路径': 'Method + Path',
  '步': 'step(s)',
  '通过选中': 'Approve Selected',
  '拒绝选中': 'Reject Selected',
  '已拒绝': 'Rejected',
  '分析任务已创建': 'Analysis task created',
  '分析失败': 'Analysis failed',
  '选择快照': 'Select Snapshot',
  '最新快照': 'Latest Snapshot',
  '文件过滤 (可选)': 'File filter (optional)',
  '运行分析': 'Run Analysis',
  '元素建议列表': 'Element Suggestions',
  '暂无元素建议': 'No element suggestions',
  '文件路径': 'File Path',
  '备用定位': 'Backup Locators',
  '搜索文件...': 'Search files...',
  '暂无文件': 'No files',
  '加载文件内容...': 'Loading file content...',
  '选择左侧文件查看内容': 'Select a file on the left to view its content',
  '文件浏览': 'File Browser',
  '请先选择项目': 'Please select a project first',

  // ── AI 源码分析 P2: 变更影响 + 链接管理 ──
  '变更影响': 'Change Impact',
  '用例链接管理': 'Test-Code Link Management',
  '分析代码变更': 'Analyze Code Changes',
  '影响链接': 'impacted links',
  '变更分析完成': 'Change analysis completed',
  'Git 导入': 'Git Import',
  'Git 仓库 URL': 'Git repository URL',
  '分支 (默认 main)': 'Branch (default: main)',
  'Git 导入成功': 'Git import successful',
  '上传成功，已自动检测代码变更': 'Upload successful. Change detection triggered automatically.',
  '新增': 'Added',
  '修改': 'Modified',
  '已处理': 'Resolved',
  '待处理': 'Unresolved',
  '未处理': 'Unresolved',
  '标记已处理': 'Mark resolved',
  '批量标记已处理': 'Bulk resolve',
  '已标记为已处理': 'Marked as resolved',
  '暂无变更影响记录': 'No change impact yet',
  '关联用例': 'Related Case',
  '变更类型': 'Change Type',
  '分析变更': 'Analyze Changes',
  '暂无用例链接': 'No test-code links yet',
  '添加链接': 'Add Link',
  '添加用例链接': 'Add Test-Code Link',
  '用例类型': 'Case Type',
  '选择类型': 'Select type',
  '用例 ID': 'Case ID',
  '输入用例 ID': 'Enter case ID',
  '关联代码文件': 'Code File',
  '选择文件 (可选)': 'Select file (optional)',
  '符号路径': 'Symbol Path',
  '如 ClassName.method (可选)': 'e.g. ClassName.method (optional)',
  '定位引用': 'Locator Ref',
  '如 CSS selector (可选)': 'e.g. CSS selector (optional)',
  '请选择用例类型': 'Select a case type',
  '请输入有效的用例 ID': 'Enter a valid case ID',
  '关联文件': 'Linked File',
  '符号': 'Symbol',
  '已关联': 'Linked',
  '已过期': 'Outdated',
  '确定删除此链接？': 'Delete this link?',
  '功能': 'Functional',

  // ── AI 源码分析 P3: diff 详情 ──
  '还有': 'and',
  '个 hunk 未显示': 'more hunk(s) not shown',
  '旧版本': 'Old version',
  '新版本': 'New version',
  '无': 'None',
  '大小变化': 'Size delta',
  '无 diff 详情': 'No diff details',
  ...
  '就绪': 'Ready',
  '草稿': 'Draft',
  '新建测试套件': 'New Test Suite',
  '输入套件名称': 'Enter suite name',
  '可选分组': 'Optional group',
  '视觉引擎 (Midscene)': 'Vision Engine (Midscene)',
  '语义引擎 (Agent Browser)': 'Semantic Engine (Agent Browser)',
  'LLM 配置': 'LLM Config',
  '选择 LLM 配置': 'Select LLM config',
  '套件创建成功': 'Suite created successfully',
  'YAML 已保存': 'YAML saved',
  '保存失败': 'Save failed',
  ...
  '确定删除此套件？': 'Delete this suite?',
  '暂无测试套件': 'No test suites',
  '支持两种引擎：Midscene 视觉引擎（截图对比）和 Agent Browser 语义引擎（DOM 语义定位）': 'Two engines supported: Midscene Vision Engine (screenshot comparison) and Agent Browser Semantic Engine (DOM semantic locating)',
  '选择套件': 'Select Suites',
  '按分组执行': 'Run by Group',
  '已选择': 'Selected',
  '个套件': 'suite(s)',
  '暂无可选套件': 'No suites available',
  '用例': 'cases',
  '批量执行(回归)': 'Batch Run (Regression)',
  '输入分组名称': 'Enter group name',
  '执行结果': 'Results',
  '总计': 'Total',
  '批量执行已启动': 'Batch run started',
  '批量执行失败': 'Batch run failed',
  '从 PRD 需求文档自动生成 YAML 测试用例，支持选择已有文档或直接粘贴文本。': 'Auto-generate YAML test cases from PRD documents. Select an existing doc or paste text directly.',
  '选择需求文档': 'Select Requirement Doc',
  '粘贴文本': 'Paste Text',
  '粘贴 PRD 内容或需求描述...': 'Paste PRD content or requirements...',
  '生成': 'Generate',
  '生成中…': 'Generating...',
  '最长 90 秒': 'max 90 seconds',
  '生成结果': 'Result',
  '编辑保存': 'Edit & Save',
  '直接运行': 'Run Now',
  '编辑生成的 YAML': 'Edit Generated YAML',
  '正在生成测试用例，请稍候…': 'Generating test cases, please wait...',
  '测试用例生成完成': 'Test case generation complete',
  '生成失败': 'Generation failed',
  '暂无需求文档，请先在需求管理中上传。': 'No requirement documents. Upload in Requirements first.',
  '仅语义引擎使用；视觉引擎缓存由 Midscene 自管理。': 'Semantic engine only; Midscene manages its own vision cache.',
  '选择器': 'Selector',
  '命中': 'Hits',
  '确定删除此缓存条目？': 'Delete this cache entry?',
  '暂无定位缓存': 'No locator cache',
  '运行语义引擎测试后，定位结果会自动缓存。': 'Locator results are cached automatically after semantic engine runs.',
  '已刷新': 'Refreshed',
  '运行详情': 'Run Detail',
  '暂无步骤数据': 'No step data',
  '暂无报告': 'No report available',
  '警告': 'Warnings',
  '错误详情': 'Error Details',
